...
export default function MemberProfilePage({ memberId }: { memberId: number }) {
  ...
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  const { data: family, refetch: refetchFamily } =
  ...
  const [foEmail, setFoEmail] = useState(
    profile?.familyOfficeContactEmail ?? "",
  );
    ...
    <div className="p-6 lg:p-8 space-y-6 animate-fade-in">
      <div>
        ...
        <p className="text-muted-foreground mt-1">
          Comprehensive data capture for personalised concierge service
        </p>
        <div className="mt-4 flex flex-wrap gap-2">
          <Link href={`/member/${id}/celebrations`}>
            <Button variant="outline" size="sm" className="gap-2">
              <Gift className="h-4 w-4" />
              Celebrations
            </Button>
          </Link>
          <Link href={`/member/${id}/trip-timeline`}>
            <Button variant="outline" size="sm" className="gap-2">
              <Globe className="h-4 w-4" />
              Trip Timeline
            </Button>
          </Link>
          <Link href={`/member/${id}/ai-concierge`}>
            <Button variant="outline" size="sm" className="gap-2">
            ...
            <div className="space-y-2">
              {ffNumbers.map((ff, i) => (
                <FrequentFlyerEntry
                  ...
                  onRemove={() =>
                    setFfNumbers((prev) => prev.filter((_, j) => j !== i))
                  }
                />
              ))}
              <Button
                ...
                onClick={() =>
                  setFfNumbers((prev) => [...prev, { airline: "", number: "" }])
                }
              >
            ...
            <div className="space-y-2">
              {hotelLoyalty.map((hl, i) => (
                <HotelLoyaltyEntry
                  ...
                  entry={hl}
                  onChange={(v) =>
                    setHotelLoyalty((prev) =>
                      prev.map((x, j) => (j === i ? v : x)),
                    )
                  }
                  onRemove={() =>
                    setHotelLoyalty((prev) => prev.filter((_, j) => j !== i))
                  }
                />
              ))}
              <Button
        ...
        <div className="pt-4 space-y-0">
          ...
          <FieldRow label="Preferred Payment">
            <Input
              ...
              placeholder="e.g. Amex Centurion"
            />
          </FieldRow>
        </div>
      </Section>
        ...
        <div className="pt-4 space-y-0">
          ...
          <FieldRow label="PA Email">
            <Input
              ...
              placeholder="pa@familyoffice.com"
            />
          </FieldRow>
          ...
          <FieldRow label="Family Office Email">
            <Input
              ...
              placeholder="fo@familyoffice.com"
            />
          </FieldRow>
        </div>
      </Section>
          ...
          <div className="border border-dashed border-border rounded-lg p-4 space-y-3 mt-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <Select
                ...
                onValueChange={setNewFamilyRelationship}
              >
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
              ...
              />
              <Input
                value={newFamilyNationality}
                onChange={(e) => setNewFamilyNationality(e.target.value)}
